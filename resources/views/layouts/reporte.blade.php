...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info bg-white col-sm-12 row justify-content-md-left">
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group col-lg-8 col-lg-push-4">
                ...
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control">
                    <button type="submit" class="btn btn-info btn-success"> Crear</button>
                  </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                  ...
                  <option>ofimatica avanzada</option>
